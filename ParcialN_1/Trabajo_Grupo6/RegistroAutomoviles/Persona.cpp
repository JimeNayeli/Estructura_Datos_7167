...
Persona::Persona(string _cedula, string _primerNombre, string _segundoNombre, string _apellido, string _direccion, string _telefono,string _placa){
	this->cedula = _cedula;
...
void Persona::setPlaca(string _placa){
	this->placa = _placa;
}
string Persona::getPlaca(){
	return this->placa;
}